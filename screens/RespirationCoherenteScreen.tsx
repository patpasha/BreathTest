...
const RespirationCoherenteScreen = ({ route, navigation }: BreathingScreenProps) => {
  ...
  const steps = [
    { name: 'Inspiration', duration: 5500, instruction: 'Inspirez lentement par le nez' },
    { name: 'Expiration', duration: 5500, instruction: 'Expirez lentement par la bouche' },
  ];
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      <View style={styles.mainContainer}>
        ...
        <View style={styles.instructionContainer}>
          <Text style={[styles.instructionTitle, { color: theme.textPrimary }]}>Respiration Cohérente</Text>
          <Text style={[styles.instructionText, { color: theme.textSecondary }]}>
            La respiration cohérente, développée par l'Institut HeartMath, vise à synchroniser votre respiration avec votre rythme cardiaque pour créer un état de cohérence physiologique.
          </Text>
          <Text style={[styles.instructionText, { color: theme.textSecondary }]}>
          ...
          <Text style={[styles.instructionText, { color: theme.textSecondary }]}>
            3. Maintenez ce rythme de 5-6 respirations par minute.
          </Text>
          <Text style={[styles.instructionText, { color: theme.textSecondary }]}>
            4. Concentrez-vous sur votre cœur ou sur des sentiments positifs pendant l'exercice.
          </Text>
          <Text style={[styles.instructionText, { color: theme.textSecondary }]}>
            Bénéfices: Réduit le stress, améliore la variabilité de la fréquence cardiaque, équilibre le système nerveux autonome.
          </Text>
        </View>
...
export default RespirationCoherenteScreen;
